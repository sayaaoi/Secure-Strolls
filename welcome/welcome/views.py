...
def enterloc(request):
    ...
    # validate_input(start_address, end_address)
            ...
            return TemplateResponse(request, 'welcome/result.html', {"test":routeText})
    else:
        loc_form = LocationForm()
    return TemplateResponse(request, 'welcome/enterloc.html',{'warning': "Please type in addresses!"})
